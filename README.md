...
- **Plankostenrechnung** — Tarifplanung für Rücklagen und Kredittilgung: Finanzierungsziel erfassen (Zielbetrag, Laufzeit, Zinssatz), die App rechnet Sparrate bzw. Annuität und schlägt drei Tarifpakete vor (grundgebühr-, verbrauchslastig, ausgewogen) inklusive Effekt auf einen Musterhaushalt und Beschlussvorlage als PDF; dazu die Verbrauchshistorie je Jahr (aus den Ablesungen berechnet, für Jahre vor der App-Einführung manuell nachtragbar)
...
- **Organisation** — Rollen- & Rechte-System (11 Bereiche), Schriftführung (Sitzungen/Protokolle/Beschlüsse, WG-Modus), Betriebsmodus Wassergenossenschaft/Versorger, Voll-Export/Import
...
Copyright © 2026 Alexander Schweiger — dual-lizenziert unter **AGPL-3.0** (Open Source mit Copyleft) und einer separaten kommerziellen Lizenz für die Betreiberin von [quellstube.at](https://quellstube.at).
